...
if(isset($_POST['search']))
	...
	if(empty($search))
		...
		if(is_numeric($search))
			...
			//Write Query
			$sql = "SELECT * FROM tblcss12a WHERE id = $search";
...
<img src="header.png" />
<form name="frmadmin" action="css12a.php" method="POST">
<h1>CSS 12 - A Outputs</h1>
...
if(isset($_POST['update']))
	...
	if(empty($id))
		...
		$sql ="UPDATE tblcss12a SET studcode = '$studcode', id = '$id', pass='$pass', name='$name', sex='$sex', gradeLevel='$gradeLevel', strand='$strand', section='$section', ww1q1='$ww1q1' , ww2q1='$ww2q1' , ww3q1='$ww3q1' , ww4q1='$ww4q1' , ww5q1='$ww5q1' , ww6q1='$ww6q1' , pt1q1='$pt1q1' , pt2q1='$pt2q1' , pt3q1='$pt3q1' , pt4q1='$pt4q1' , ww1q2='$ww1q2' , ww2q2='$ww2q2' , ww3q2='$ww3q2' , ww4q2='$ww4q2' , ww5q2='$ww5q2' , ww6q2='$ww6q2', pt1q2='$pt1q2' , pt2q2='$pt2q2' , pt3q2='$pt3q2' , pt4q2='$pt4q2'   WHERE id = '$id' ";
...
if(isset($_POST['add']))
	...
	if(empty($id))
		...
		//Write Query
		$sql ="INSERT INTO tblcss12a(studcode, id, pass, name, sex, gradeLevel, strand, section, ww1q1, ww2q1, ww3q1, ww4q1, ww5q1, ww6q1, pt1q1 , pt2q1, pt3q1, pt4q1, ww1q2, ww2q2, ww3q2, ww4q2, ww5q2, ww6q2, pt1q2 , pt2q2, pt3q2, pt4q2) VALUES('$studcode', '$id', '$pass', '$name', '$sex', '$gradeLevel', '$strand', '$section', '$ww1q1', '$ww2q1', '$ww3q1', '$ww4q1', '$ww5q1', '$ww6q1', '$pt1q1' , '$pt2q1', '$pt3q1', '$pt4q1', '$ww1q2', '$ww2q2', '$ww3q2', '$ww4q2', '$ww5q2', '$ww6q2', '$pt1q2' , '$pt2q2', '$pt3q2', '$pt4q2')";	
...
//=============Deleting Information=================
	if(is_numeric($search))
		...
		if(isset($_POST['delete']))
			...
			$sql = "DELETE FROM tblcss12a WHERE id=$search";
